...
public class simulacionMarcas2 {
        ...
        if(modo.equals("Final")){
            try {
                ...
                if (cal.equals("Cal1")) {
                    ...
                    String consulta = "SELECT * FROM planta2.empleados1 WHERE TIPO = 1";
                    ...
                    String empleadoCiclo = "SELECT * FROM planta2.empleados1 WHERE id = " + empleadoAleatorio;
                    ...
                    if (rsec.next()) {
                        if (probabilidad(ausentismo)) {
                            ...
                            if (probabilidad(tardías)) {
                                ...
                                try (CallableStatement cst = con.prepareCall("{CALL planta2.`MARCAR ENTRADA`(?, ?, ?)}")) {
                            ...
                            if (probabilidad(omision)) {
                                ...
                                try (CallableStatement cst = con.prepareCall("{CALL planta2.`MARCAR_SALIDA`(?, ?, ?)}")) {
                                    cst.setInt(1, Integer.parseInt(rsec.getString("id")));
                                    cst.setDate(2, java.sql.Date.valueOf(fechaAleatoria));
                    ...
                    Connection con = conexion.con;
                    Statement st = con.createStatement();
                    String consulta = "SELECT * FROM planta2.empleados1 WHERE TIPO = 2";
                    ResultSet rs = st.executeQuery(consulta);
                    List<Integer> listaempleados = new ArrayList<>();
                    while (rs.next()) {
                        listaempleados.add(rs.getInt("id"));
                    ...
                    Connection con = conexion.con;
                    Statement st = con.createStatement();
                    String consulta = "SELECT * FROM planta2.empleados1 WHERE TIPO = 3";
                    ResultSet rs = st.executeQuery(consulta);
                    List<Integer> listaempleados = new ArrayList<>();
                    while (rs.next()) {
                        listaempleados.add(rs.getInt("id"));
                    ...
                    Connection con = conexion.con;
                    Statement st = con.createStatement();
                    String consulta = "SELECT * FROM planta2.empleados1 WHERE TIPO = 4 OR TIPO = 5";
                    ResultSet rs = st.executeQuery(consulta);
                    List<Integer> listaempleados = new ArrayList<>();
                    while (rs.next()) {
                        listaempleados.add(rs.getInt("id"));
                    ...
                    Connection con = conexion.con;
                    Statement st = con.createStatement();
                    String consulta = "SELECT * FROM planta2.empleados1";
                    ResultSet rs = st.executeQuery(consulta);
                    List<Integer> listaempleados = new ArrayList<>();
                    while (rs.next()) {
                        listaempleados.add(rs.getInt("id"));
