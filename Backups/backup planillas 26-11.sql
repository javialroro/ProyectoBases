...
--
-- Table structure for table `lineplanillas`
--

DROP TABLE IF EXISTS `lineplanillas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lineplanillas` (
  ...
  `fecha` date DEFAULT NULL,
  `horas_laboradas` int DEFAULT NULL,
  `horas_extra` int DEFAULT NULL,
  `horas_normales` int DEFAULT NULL,
  `salario_bruto` double DEFAULT NULL,
  `salario_neto` double DEFAULT NULL,
  PRIMARY KEY (`idPlanilla`,`lineNum`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `marcas1` VALUES (1,'2023-04-11','07:30:00','17:30:00'),(1,'2023-04-12','09:30:00','14:00:00'),(30,'2023-04-11','08:00:00','17:30:00'),(30,'2023-11-17','07:30:00','17:30:00'),(30,'2023-11-21','07:30:00','05:30:00'),(30,'2023-11-22','07:30:00','17:37:00'),(30,'2023-11-24','07:00:00','16:31:00'),(30,'2023-11-25','07:30:00','08:01:00');
...
CREATE TABLE `planillas` (
  ...
  PRIMARY KEY (`fechaInicio`,`fechaFinal`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `planillas` VALUES (1,'2023-11-01','2023-11-30',0);
...
--
-- Temporary view structure for view `vista_planilla`
--

DROP TABLE IF EXISTS `vista_planilla`;
/*!50001 DROP VIEW IF EXISTS `vista_planilla`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_planilla` AS SELECT 
 1 AS `id`,
 1 AS `nombre`,
 1 AS `calendario`,
 1 AS `tipo_planilla`*/;
...
--
-- Final view structure for view `vista_planilla`
--
...
/*!50001 VIEW `vista_planilla` AS select `empleados1`.`id` AS `id`,`empleados1`.`nombre` AS `nombre`,`tipo_empleado1`.`calendario` AS `calendario`,`t`.`nombre` AS `tipo_planilla` from (((`empleados1` join `tipo_empleado1` on((`empleados1`.`tipo` = `tipo_empleado1`.`id`))) join `calendarios1` on((`tipo_empleado1`.`calendario` = `calendarios1`.`id`))) join `tipo_planilla1` `t` on((`calendarios1`.`tipo_planilla` = `t`.`id`))) order by `empleados1`.`id` */;
...
-- Dump completed on 2023-11-26 20:17:42
